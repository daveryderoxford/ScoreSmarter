...
describe('scoreSeriesSnapshot', () => {
  it('matches scorer orchestrator behavior for same inputs', () => {
    ...
    const entries: SeriesEntry[] = [
      { id: 'e1', seriesId: 'series-1', helm: 'A', boatClass: 'Laser', sailNumber: '101', handicaps: [{ scheme: 'PY', value: 1000 }], divisions: [] },
      { id: 'e2', seriesId: 'series-1', helm: 'B', boatClass: 'Laser', sailNumber: '102', handicaps: [{ scheme: 'PY', value: 1000 }], divisions: [] },
    ];
    const competitors = [
      new RaceCompetitor({
        id: 'c1',
